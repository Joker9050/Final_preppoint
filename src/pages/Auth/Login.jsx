...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href = 'http://your-api-endpoint/auth/google';
  };
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            <div className="p-8">
              ...
              <button
                ...
                className="w-full flex items-center justify-center py-3 px-4 mb-6 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-all"
              >
                <img 
